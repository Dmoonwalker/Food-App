...
// Route to display the comments section.
// This GET route calls the 'index' method in CommentController to show the page where comments are displayed.
Route::get('/comments', [CommentController::class, 'index']);

// Route to store new comments.
// This POST route calls the 'store' method in CommentController to add a new comment when a form is submitted.
