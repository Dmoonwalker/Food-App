            ...
            <div class="card-body">
                <form id="downloadForm">
                    ...
                    <div class="position-relative">
                             <input type="url" class="form-control rounded-input pr-5" id="playlist_url" name="playlist_url" placeholder="Enter YouTube Playlist URL" required>
                             <button type=" submit" class="btn themed-button position-absolute" style="top: 0; right: 0; height: 100%; border-left: none;">
                                <i class="fas fa-download themed-icon"></i>
                             </button>
                    </div>
